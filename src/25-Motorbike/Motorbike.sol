...
import "https://raw.githubusercontent.com/OpenZeppelin/openzeppelin-contracts/release-v3.4/contracts/proxy/Initializable.sol";
...
contract Attack {
    ...
    Motorbike public motor = new Motorbike(address(engine));
